...
class MediakeyResponsesController extends Controller
{
    public function index()
    {
        return view("mediakey.responses.index");
    }
    ...
    public function storeReps(ImportRepRequest $request)
    {
        ...
        foreach ($archivos as $file) {
            ...
            $valid = Repsmediakey::where('source_file', 'like', $source)->get();
    ...
    public function storePdf(ImportRepRequest $request)
    {
        ...
        foreach ($archivos as $file) {
            ...
            $valid = RespuestasBanorteMediakey::where('source_file', 'like', $source)->get();
