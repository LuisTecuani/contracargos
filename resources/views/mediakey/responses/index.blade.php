...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1><b>Respuestas de cobro Mediakey</b></h1>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md">
                <div class="card bg-light mt-2">
                    <form action="{{ route('mediakey.responses.storeReps') }}" method="POST" enctype="multipart/form-data">
                        @include('contracargos.admin.import_rep')
                    </form>
                </div>
            </div>
            <div class="col-md">
                <form method="POST" action="{{ route('mediakey.responses.storePdf') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card bg-light mt-2">
