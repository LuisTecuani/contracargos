        ...
        <div class="row">
            ...
            <div class="col mt-5">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card bg-light mt-2">
                            <form method="POST" action="{{ route('cellers.cobroBanorteFtp') }}"
                ...
                <div class="row">
                    <div class="col">
                        <div class="card bg-light mt-2">
                            <form method="POST" action="{{ route('cellers.banorteBillingRejected') }}"
                                  enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <div class="card-header">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card bg-light mt-2">
                            <form method="POST" action="{{ route('cellers.banorteUsersTextbox') }}"
                                  enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <div class="card-header">
