    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 bg-light mt-2">
                <h1><b>Creacion de archivos Cellers para el cobro</b></h1>
            ...
            <div class="col mt-5">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card bg-light mt-2">
                            <form method="POST" action="{{ route('cellers.billing_users.storeFtp') }}"
                ...
                <div class="row">
                    <div class="col">
                        <div class="card bg-light mt-2">
                            <form method="POST" action="{{ route('cellers.billing_users.storeRejectedProsa') }}"
                                  enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <div class="card-header">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card bg-light mt-2">
                            <form method="POST" action="{{ route('cellers.billing_users.storeTextbox') }}"
                                  enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <div class="card-header">
