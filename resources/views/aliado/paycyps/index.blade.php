    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 bg-light mt-2">
                <h1><b>Aliado Paycyps </b></h1>
                @include('aliado._navLinks')
                @include('aliado.paycyps._navLinks')
            </div>
            <div class="col">
                <div class="card bg-light mt-2">
                    <form method="POST" action="{{ route('aliado.paycyps.storeCsv') }}"
        ...
        <div class="row">
            <div class="col-md  bg-light mt-2">
                <form method="POST" action="{{ route('aliado.paycyps.chargebackStore') }}">
                    <div class="card-header">
            ...
            <div class="col-md  bg-light mt-2">
                <form method="POST" action="{{ route('aliado.paycyps.update') }}">
                    <div class="card-header">
            ...
            <div class="col">
                <div class="card bg-light mt-2">
                    <form method="POST" action="{{ route('aliado.paycyps.updateCsv') }}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="card bg-light mt-2">
                            <div class="card-header">
        ...
        <div class="row">
            <div class="col">
                <div class="card bg-light mt-2">
                    <form method="POST" action="{{ route('aliado.paycypsHistoric.store') }}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="card bg-light mt-2">
                            <div class="card-header">
        ...
        <div class="row">
            <div class="col">
                <div class="card bg-light mt-2">
                    <form method="POST" action="{{ route('aliado.paycypsHistoric.storeFolios') }}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="card bg-light mt-2">
                            <div class="card-header">
