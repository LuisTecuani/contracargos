    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 mt-2">
                ...
                @include('urbano.chargeback._navLinks')
            </div>
            <div class="col-md mt-2">
                <form method="POST" action="{{ route('urbanoChargeback.store') }}">
        ...
        <div class="row">
            <div class="col-md">
                <div class="card bg-light mt-2">
                    <form action="{{ route('urbanoBanorteChargeback.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-header">
