    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 bg-light mt-2">
                <h1><b>Creacion de archivos Thx para el cobro</b></h1>
            ...
            <div class="col mt-5">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card bg-light mt-2">
                            <form method="POST" action="{{ route('thx.billing_users.storeFtp') }}"
                ...
                <div class="row">
                    <div class="col">
                        <div class="card bg-light mt-2">
                            <form method="POST" action="{{ route('thx.billing_users.storeRejectedProsa') }}"
                                  enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <div class="card-header">
                ...
                <div class="row">
                    <div class="col">
                        <div id="collapseTen"  aria-labelledby="headingTen" >
                            <div class="card-body">
                                @include('thx.file_making._rejectedToBanorte')
                            </div>
                            <div class="pt-4">
                                <ul class="nav flex-column">
                                    <li class="nav-item pt-2">
                                        <a href="/thx/file_making/exportBanorte" class="btn btn-outline-danger">crear CSV para cobro banorte</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="card bg-light mt-2">
                            <form method="POST" action="{{ route('thx.billing_users.storeTextbox') }}"
                                  enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <div class="card-header">
