    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 bg-light mt-2">
                ...
                @include('thx.paycyps._navLinks')
            </div>
            <div class="col">
                <div class="card bg-light mt-2">
                    <form method="POST" action="{{ route('thx.paycyps.storeCsv') }}"
        ...
        <div class="row">
            <div class="col-md  bg-light mt-2">
                <form method="POST" action="{{ route('thx.paycyps.chargebackStore') }}">
                    <div class="card-header">
            ...
            <div class="col-md  bg-light mt-2">
                <form method="POST" action="{{ route('thx.paycyps.update') }}">
                    <div class="card-header">
            ...
            <div class="col-md  bg-light mt-2">
                <div class="card bg-light mt-2">
                    <form method="POST" action="{{ route('thx.paycyps.updateCsv') }}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="card bg-light mt-2">
                            <div class="card-header">
        ...
        <div class="row">
            <div class="col">
                <div class="card bg-light mt-2">
                    <form method="POST" action="{{ route('thx.paycypsHistoric.store') }}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="card bg-light mt-2">
                            <div class="card-header">
        ...
        <div class="row">
            <div class="col">
                <div class="card bg-light mt-2">
                    <form method="POST" action="{{ route('thx.paycypsHistoric.storeFolios') }}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="card bg-light mt-2">
                            <div class="card-header">
