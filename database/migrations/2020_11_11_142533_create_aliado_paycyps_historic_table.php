...
class CreateAliadoPaycypsHistoricTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aliado_paycyps_historics', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('aliado_paycyps_historics');
    }
}
